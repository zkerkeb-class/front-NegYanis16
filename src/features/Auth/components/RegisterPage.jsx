...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(data.token); // Connexion automatique
      navigate('/dashboard');  // Redirige vers la home après inscription
    } catch (err) {
      ...
      <div className="relative max-w-lg w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
            Rejoignez <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">QuizPro</span>
          </h1>
          <p className="text-gray-600">
            Créez votre compte et commencez votre apprentissage personnalisé
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="prenom" className="block text-sm font-semibold text-gray-700 mb-3">
                  Prénom
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
